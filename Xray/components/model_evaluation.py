...
from Xray.entity.artifact_entity import DataTransformationArtifact, ModelEvaluationArtifact, ModelTrainerArtifact
...
class ModelEvaluation:
    def __init__(self,
                ...
                model_trainer_artifact: ModelEvaluationArtifact):
