...
class Net(nn.Module):
        def __init__(self):
                ...
                self.convolution_block_4 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=10, 
                                                out_channels=20, 
                                                kernel_size=(3,3), 
                ...
                self.convolution_block_5 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=20, 
                                                out_channels=32, 
                                                kernel_size=(1,1), 
                ...
                self.convolution_block_6 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=32, 
                                                out_channels=10, 
                                                kernel_size=(3,3), 
                ...
                self.convolution_block_7 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=10, 
                                                out_channels=10, 
                                                kernel_size=(1,1), 
                ...
                self.convolution_block_8 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=10, 
                                                out_channels=14, 
                                                kernel_size=(3,3), 
                ...
                self.convolution_block_9 = nn.Sequential(
                                        nn.Conv2d(
                                                in_channels=14, 
                                                out_channels=16, 
                                                kernel_size=(3,3), 
        ...
        def forward(self, x) -> float:
                ...
                x = self.convolution_block_3(x)

                x = self.pooling33(x)

                x = self.convolution_block_4(x)

                x = self.convolution_block_5(x)

                x = self.convolution_block_6(x)

                x = self.convolution_block_7(x)

                x = self.convolution_block_8(x)

                x = self.convolution_block_9(x)
